...
class TestDeniedPaths:
    ...
    def test_denied_path_basic(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            decision, reason = check_path(str(test_file), deny_list, base_dir)
    ...
    def test_denied_in_subdir(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            decision, _ = check_path(str(test_file), deny_list, base_dir)
            assert decision == "deny"
    ...
    def test_deeply_nested_paths(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            decision, _ = check_path(str(deep_file), deny_list, base_dir)
            assert decision == "deny"
    ...
    def test_denied_absolute_path(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            decision, _ = check_path(absolute_path, deny_list, some_other_dir)
            assert decision == "deny"
    ...
    def test_different_files_with_same_name(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            decision, _ = check_path(str(first_file), deny_list, base_dir)
            assert decision == "deny"

            # other/config.yaml should be allowed
            decision, _ = check_path(str(second_file), deny_list, base_dir)
            assert decision is None

            # config.yaml should be allowed
            decision, _ = check_path(str(third_file), deny_list, base_dir)
            assert decision is None
    ...
    def test_allowed_file(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            decision, _ = check_path("readme.md", deny_list, base_dir)
            assert decision is None
    ...
    def test_empty_deny_list(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            base_dir = Path(tmpdir)
            decision, _ = check_path("any_file.txt", [], base_dir)
            assert decision is None
    ...
    def test_relative_path_resolution_from_base_dir(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            decision, _ = check_path(str(config1), deny_list, base_dir)
            assert decision == "deny"

            # config.yaml in project2 should be allowed (different absolute path)
            decision, _ = check_path(str(config2), deny_list, base_dir)
            assert decision is None
