...
class TestCwdVariable:
    ...
    def test_cwd_substituted_in_deny_pattern(self):
        ...
        decision, reason, _ = check_command("cd /my/project && pytest", rules, cwd="/my/project")
    ...
    def test_cwd_not_matched_when_different_path(self):
        ...
        decision, _, _ = check_command("cd /other/path && pytest", rules, cwd="/my/project")
    ...
    def test_cwd_substituted_in_allow_pattern(self):
        ...
        decision, _, _ = check_command("cd /my/project && pytest -v", rules, cwd="/my/project")
    ...
    def test_cwd_substituted_in_confirm_pattern(self):
        ...
        decision, _, _ = check_command("cd /my/project && git push", rules, cwd="/my/project")
    ...
    def test_cwd_with_special_regex_chars_in_path(self):
        ...
        decision, _, _ = check_command("cd /my/proj.ect/foo && ls", rules, cwd="/my/proj.ect")
        assert decision == "deny"

        # Should NOT match a path where dot acts as a wildcard
        decision, _, _ = check_command("cd /my/projXect/foo && ls", rules, cwd="/my/proj.ect")
        assert decision is None
    ...
    def test_no_cwd_provided_leaves_pattern_unchanged(self):
        ...
        decision, _, _ = check_command("cd /some/path && ls", rules, cwd=None)
    ...
    def test_pattern_without_cwd_variable_unaffected(self):
        ...
        decision, _, _ = check_command("rm -rf /tmp", rules, cwd="/my/project")
